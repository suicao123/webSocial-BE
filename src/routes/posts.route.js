...
router.delete('/deleteComment/:id', authMidleware, postController.deleteComment);
router.put('/updatePost/:id', authMidleware, postController.updatePost);
...
router.post('/postsProfile/:id', authMidleware, postController.getPostProfile);
